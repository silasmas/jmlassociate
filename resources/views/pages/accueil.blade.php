        ...
        <ul>
                <li data-index="rs-6" data-transition="parallaxtoright" data-slotamount="default"  data-easein="default" data-easeout="default" data-masterspeed="default" data-delay="6510"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-description="">
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-0"
                        ...
                        style="z-index: 7;"><img src="{{ asset('assets/images/line-slider.jpg') }}" alt="" width="2" height="34" data-ww="['2px','2px','2px','2px']" data-hh="['34px','34px','34px','34px']" data-no-retina>
                    </div>
                ...
                <li data-index="rs-7" data-transition="parallaxtoright" data-slotamount="default"  data-easein="default" data-easeout="default" data-masterspeed="default" data-delay="6500"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-description="">
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-0"
                        ...
                        style="z-index: 8;"><img src="{{ asset('assets/images/slider-icon1.png') }}" alt="" width="100" height="100" data-ww="['61px','61px','61px','61px']" data-hh="['62px','62px','62px','62px']" data-no-retina>
                    </div>
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-0"
                        ...
                        style="z-index: 9;"><img src="{{ asset('assets/images/slider-icon2.png') }}" alt="" width="100" height="100" data-ww="['62px','62px','62px','62px']" data-hh="['62px','62px','62px','62px']" data-no-retina>
                    </div>
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-0"
                        ...
                        style="z-index: 10;"><img src="{{ asset('assets/images/slider-icon3.png') }}" alt="" width="100" height="100" data-ww="['62px','62px','62px','62px']" data-hh="['62px','62px','62px','62px']" data-no-retina>
                    </div>
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-0"
                        ...
                        style="z-index: 11;"><img src="{{ asset('assets/images/slider-icon4.png') }}" alt="" width="100" height="100" data-ww="['62px','62px','62px','62px']" data-hh="['62px','62px','62px','62px']" data-no-retina>
                    </div>
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-0"
                        ...
                        style="z-index: 12;"><img src="{{ asset('assets/images/slider-icon5.png') }}" alt="" width="100" height="100" data-ww="['61px','61px','61px','61px']" data-hh="['62px','62px','62px','62px']" data-no-retina>
                    </div>
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-0"
                        ...
                        style="z-index: 13;"><img src="{{ asset('assets/images/slider-icon6.png') }}" alt="" width="100" height="100" data-ww="['62px','62px','62px','62px']" data-hh="['62px','62px','62px','62px']" data-no-retina>
                    </div>
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-0"
                        ...
                        style="z-index: 14;"><img src="{{ asset('assets/images/slider-icon7.png') }}" alt="" width="100" height="100" data-ww="['62px','62px','62px','62px']" data-hh="['62px','62px','62px','62px']" data-no-retina>
                    </div>
                </li>
                <li data-index="rs-14" data-transition="parallaxtoright" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-delay="6510" data-rotate="0" data-saveperformance="off" data-title="Slider3-Layer1" data-description="">
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-0"
                        ...
                        style="z-index: 5;"><img src="{{ asset('assets/images/slider3_ly2.png') }}" alt="" width="38" height="58" data-ww="['38px','38px','38px','38px']" data-hh="['58px','58px','58px','58px']" data-no-retina>
                    </div>
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-0"
                        ...
                        style="z-index: 7;"><img src="{{ asset('assets/images/slider3_ly3.jpg') }}" alt="" width="32" height="18" data-ww="['32px','32px','32px','32px']" data-hh="['18px','18px','18px','18px']" data-no-retina>
                    </div>
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-0"
                        ...
                        style="z-index: 8;"><img src="{{ asset('assets/images/line-white.jpg') }}" alt="" width="384" height="2" data-ww="['384px','384px','384px','384px']" data-hh="['2px','2px','2px','2px']" data-no-retina>
                    </div>
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-0"
                        ...
                        style="z-index: 10;"><img src="{{ asset('assets/images/line-white-text.png') }}" alt="" width="384" height="16" data-ww="['384px','384px','384px','384px']" data-hh="['16px','16px','16px','16px']" data-no-retina>
                    </div>
                ...
                <div class="help-inner">
                    ...
                    <div class="col-sm-4 col-md-4 no-padding">
                        <div class="help-single text-center">
                            ...
                            <p>When i accept your case, i'll never require you to pay huge fees or expenses because i work with a low cost and care for you.</p>
                        </div>
                    </div>
                    <div class="col-sm-4 col-md-4 no-padding">
                        <div class="help-single text-center">
                            ...
                            <p>Get a full thorough review of your legal documents by an expert attorney for the little price, as little as $0 per document.</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="history-right-content">
                            <div class="col-sm-4 col-md-4">
                                <div class="h-right-img">
                                    <img src="{{ asset('assets/images/history-right-img.png') }}" class="img-responsive" alt="">
                    ...
                    <div class="t-b-content-area">
                        <div class="col-md-3 col-sm-6">
                            <div class="t-b-details">
                                <div class="t-b-img">
                                    <img src="{{ asset('assets/images/testimonial-blog-post-1.png') }} " class="img-responsive" alt="blog-post">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="t-b-details">
                                <div class="t-b-img">
                                    <img src="{{ asset('assets/images/testimonial-blog-post-2.png') }} " class="img-responsive" alt="blog-post">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="t-b-details">
                                <div class="t-b-img">
                                    <img src="{{ asset('assets/images/testimonial-blog-post-3.png') }} " class="img-responsive" alt="blog-post">
                                    <div><span>JUNE</span><span>28</span></div>
                                </div>
                                <div class="t-b-comment">
                                    <p>Posted In: <span>Careers</span></p>
                                    <p><span><a href="#"><i class="fa fa-comments"></i></a> 15</span>
                                       <span><a href="#"><i class="fa fa-eye"></i></a> 11</span></p>
                                </div>
                                <h2><a href="#">New Careers, what makes you qualified?</a></h2>
                                <p>We cannot expect people to have respect for laws and orders until we teach respect to those we have entrusted to enforce those laws.</p>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="t-b-details">
                                <div class="t-b-img">
                                    <img src="{{ asset('assets/images/testimonial-blog-post-4.png') }} " class="img-responsive" alt="blog-post">
                                    <div><span>JUNE</span><span>26</span></div>
                                </div>
                                <div class="t-b-comment">
                                    <p>Posted In: <span>Updates</span></p>
                                    <p><span><a href="#"><i class="fa fa-comments"></i></a> 15</span><span><a href="#"><i class="fa fa-eye"></i></a> 11</span></p>
                                </div>
                                <h2><a href="#">All About human laws, our rich and useful library.</a></h2>
                                <p>It’s no secret that the digital industry is booming. From exciting startups to global brands, companies are reaching out to digital agencies, responding to...</p>
                            </div>
                        </div>
                    </div>
